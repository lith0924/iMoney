...
public class SwaggerConfiguration {
	...
	public Docket sysDocket() {
		return docket("系统模块",
			Collections.singletonList(AppConstant.BASE_PACKAGES + ".modules.system"));
	}

	@Bean
	public Docket bsDocket() {
		return docket("业务模块",
			Collections.singletonList(AppConstant.BASE_PACKAGES + ".modules.business"));
	}
